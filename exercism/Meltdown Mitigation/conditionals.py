...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    percenraje_low = (threshold * 90) / 100
    percenraje_normal = (threshold * 10) / 100
    criticality = temperature * neutrons_produced_per_second

    if criticality < percenraje_low : 
        return 'LOW'
    elif criticality <= threshold + percenraje_normal and criticality >= threshold - percenraje_normal : 
        return 'NORMAL'
